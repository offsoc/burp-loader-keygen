...
import com.intellij.uiDesigner.core.SupportCode.1;
...
public final class SupportCode {
   public static SupportCode.TextWithMnemonic parseText(String textWithMnemonic) {
      if (textWithMnemonic == null) {
         ...
         return new SupportCode.TextWithMnemonic(plainText.toString(), index, (1)null);
      }
   }
   ...
   public static final class TextWithMnemonic {
      ...
      // $FF: synthetic method
      TextWithMnemonic(String x0, int x1, 1 x2) {
         this(x0, x1);
      }
   }
}
