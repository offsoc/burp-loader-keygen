...
public class KeygenDialog {
   ...
   private KeygenDialog() {
      ...
      this.loaderTextField.addPropertyChangeListener(new PropertyChangeListener() {
         public void propertyChange(PropertyChangeEvent evt) {
            ...
            KeygenDialog.this.loaderTextField.setText("java -Xbootclasspath/p:" + filename + " -jar " + newest_file);
         }
      });
   ...
   private String generateLicense(String licenseName) {
      String[] licenseArray = new String[]{this.getRandomString(), "license", licenseName, String.valueOf((new Date()).getTime() + 315569521000L), "1", "full", "tdq99QBI3DtnQQ7rRJLR0uAdOXT69SUfAB/8O2zi0lsk4/bXkM58TP6cuhOzeYyrVUJrM11IsJhWrv8SiomzJ/rqledlx+P1G5B3MxFVfjML9xQz0ocZi3N+7dHMjf9/jPuFO7KmGfwjWdU4ItXSHFneqGBccCDHEy4bhXKuQrA="};
   ...
   public static void main(String[] args) throws ClassNotFoundException, UnsupportedLookAndFeelException, InstantiationException, IllegalAccessException {
      ...
      JFrame frame = new JFrame("Burp Suite Pro 1.7.31 Loader & Keygen - By surferxyz");
